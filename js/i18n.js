...
(function () {
  ...
  const dict = {
    en: {
      ...
      card_play_text: "Guess as many Pokemon silhouettes in a row as you can. One wrong answer ends the run - share your best streak with friends!",
      card_play_btn: "Play now",
      card_sync_title: "Sync your Pokemon Desktop",
      card_sync_title_synced: "Check your Pokemon Desktop Points and Pokedex",
      card_sync_text: "Log in and enter your Activation Code (shown on your Pokemon Desktop) to see your lifetime stats and Pokedex here.",
      ...
      play_state_correct: "Correct! Next Pokemon...",
      play_state_wrong: "Wrong! Game over.",
      play_oak_message: "Professor Oak is disappointed in your Pokedex knowledge.",
    ...
    pt: {
      ...
      card_play_title: "Jogue o desafio de sequencia",
      card_play_text: "Acerte o maximo de silhuetas de Pokemon seguidas que conseguir. Um erro encerra a rodada - compartilhe sua sequencia com os amigos!",
      card_play_btn: "Jogar agora",
      card_sync_title: "Sincronize seu Pokemon Desktop",
      card_sync_title_synced: "Veja seus pontos e Pokedex do Pokemon Desktop",
      card_sync_text: "Entre na sua conta e digite o Codigo de Ativacao (mostrado no seu Pokemon Desktop) para ver suas estatisticas e Pokedex aqui.",
      card_sync_btn: "Entrar / Vincular dispositivo",
      card_leaderboard_title: "Ranking global",
      card_leaderboard_text: "Veja como sua melhor sequencia se compara com outros treinadores.",
      card_leaderboard_btn: "Ver ranking",
      footer_text: "Pokemon Desktop Online - Barba Productions",

      play_title: "Quem e esse Pokemon?",
      play_loading: "Carregando...",
      play_streak_label: "Sequencia:",
      play_next_btn: "Proximo",
      play_game_over_title: "Fim de jogo!",
      play_your_streak: "Sua sequencia:",
      play_name_label: "Seu nome (para o ranking)",
      play_name_placeholder: "Treinador",
      play_submit_btn: "Enviar pontuacao",
      play_share_btn: "Compartilhar pontuacao",
      play_again_btn: "Jogar novamente",
      play_state_correct: "Certo! Proximo Pokemon...",
      play_state_wrong: "Errado! Fim de jogo.",
      play_oak_message: "O Professor Carvalho ficou decepcionado com seu conhecimento da Pokedex.",
      play_submit_submitting: "Enviando...",
      play_submit_ok: "Pontuacao enviada! Confira o ranking.",
      play_submit_error: "Nao foi possivel enviar a pontuacao (o Firebase ja esta configurado?).",
      play_share_copied: "Copiado!",
      play_share_copy_label: "Copiar texto para compartilhar",

      leaderboard_title: "Melhores sequencias",
      leaderboard_col_trainer: "Treinador",
      leaderboard_col_streak: "Sequencia",
      leaderboard_loading: "Carregando...",
      leaderboard_empty: "Ainda sem pontuacoes. Seja o primeiro!",
      leaderboard_error: "Nao foi possivel carregar o ranking (o Firebase ja esta configurado?).",
      ...
      link_help: "Encontre seu Codigo de Ativacao no Pokemon Desktop: segure a tela na pagina inicial por 4 segundos.",
      link_input_label: "Codigo de Ativacao",
      link_btn: "Vincular dispositivo",
      link_status_none: "Nenhum dispositivo vinculado ainda.",
      link_status_invalid: "Isso nao parece um Codigo de Ativacao valido (formato XXX-XXXX-XXX).",
      link_status_linking: "Vinculando...",
      link_status_linked: "Dispositivo vinculado!",
      link_status_no_stats: "Vinculado, mas ainda sem estatisticas. Termine um jogo no seu dispositivo primeiro.",
      link_status_error: "Nao foi possivel vincular o dispositivo. Tente novamente.",
      stats_title: "Suas estatisticas",
      stat_score: "Pontuacao vitalicia",
      stat_caught: "Pokedex capturados",
      stat_correct: "Total de acertos",
      stat_wrong: "Total de erros",
      stat_days: "Dias jogados",
      stat_trainer: "Nome do treinador",
      pokedex_title: "Sua Pokedex",
    },
    es: {
      nav_home: "Inicio",
      nav_play: "Jugar",
      nav_leaderboard: "Clasificacion",
      nav_account: "Iniciar sesion / Sincronizar",

      home_subtitle: "El companero web de tu Pokemon Desktop.",
      card_play_title: "Juega la racha de aciertos",
      card_play_text: "Adivina la mayor cantidad de siluetas de Pokemon seguidas que puedas. Un error termina la partida - comparte tu mejor racha con tus amigos!",
      card_play_btn: "Jugar ahora",
      card_sync_title: "Sincroniza tu Pokemon Desktop",
      card_sync_title_synced: "Consulta tus puntos y Pokedex del Pokemon Desktop",
      card_sync_text: "Inicia sesion e ingresa tu Codigo de Activacion (que aparece en tu Pokemon Desktop) para ver tus estadisticas y Pokedex aqui.",
      card_sync_btn: "Iniciar sesion / Vincular dispositivo",
      card_leaderboard_title: "Clasificacion global",
      card_leaderboard_text: "Mira como se compara tu mejor racha con la de otros entrenadores.",
      card_leaderboard_btn: "Ver clasificacion",
      footer_text: "Pokemon Desktop Online - Barba Productions",

      play_title: "Quien es ese Pokemon?",
      ...
      play_name_label: "Tu nombre (para la clasificacion)",
      play_name_placeholder: "Entrenador",
      play_submit_btn: "Enviar puntuacion",
      play_share_btn: "Compartir mi puntuacion",
      play_again_btn: "Jugar de nuevo",
      play_state_correct: "Correcto! Siguiente Pokemon...",
      play_state_wrong: "Incorrecto! Fin del juego.",
      play_oak_message: "El Profesor Oak esta decepcionado de tu conocimiento Pokedex.",
      play_submit_submitting: "Enviando...",
      play_submit_ok: "Puntuacion enviada! Revisa la clasificacion.",
      play_submit_error: "No se pudo enviar la puntuacion (ya esta configurado Firebase?).",
      play_share_copied: "Copiado!",
      ...
      leaderboard_empty: "Aun no hay puntuaciones. Se el primero!",
      leaderboard_error: "No se pudo cargar la clasificacion (ya esta configurado Firebase?).",

      account_title: "Tu cuenta",
      auth_email_label: "Correo electronico",
      auth_password_label: "Contrasena",
      auth_password_placeholder: "Al menos 6 caracteres",
      auth_login_btn: "Iniciar sesion",
      auth_signup_btn: "Crear cuenta",
      dashboard_signed_in_as: "Sesion iniciada como",
      dashboard_logout_btn: "Cerrar sesion",
      link_title: "Vincula tu Pokemon Desktop",
      link_help: "Encuentra tu Codigo de Activacion en tu Pokemon Desktop: manten la pantalla presionada en la pagina de inicio por 4 segundos.",
      link_input_label: "Codigo de Activacion",
      link_btn: "Vincular dispositivo",
      link_status_none: "Aun no hay dispositivo vinculado.",
      link_status_invalid: "Eso no parece un Codigo de Activacion valido (formato XXX-XXXX-XXX).",
      link_status_linking: "Vinculando...",
      link_status_linked: "Dispositivo vinculado!",
      link_status_no_stats: "Vinculado, pero aun sin estadisticas. Termina una partida en tu dispositivo primero.",
      link_status_error: "No se pudo vincular el dispositivo. Intenta de nuevo.",
      stats_title: "Tus estadisticas",
      stat_score: "Puntuacion de por vida",
      stat_caught: "Pokedex capturados",
      stat_correct: "Total de aciertos",
      stat_wrong: "Total de errores",
      stat_days: "Dias jugados",
      stat_trainer: "Nombre de entrenador",
      pokedex_title: "Tu Pokedex",
    },
    de: {
      nav_home: "Start",
      nav_play: "Spielen",
      ...
      card_play_text: "Errate so viele Pokemon-Silhouetten hintereinander wie moeglich. Eine falsche Antwort beendet den Lauf - teile deine beste Serie mit Freunden!",
      card_play_btn: "Jetzt spielen",
      card_sync_title: "Pokemon Desktop synchronisieren",
      card_sync_title_synced: "Deine Pokemon Desktop Punkte und Pokedex ansehen",
      card_sync_text: "Melde dich an und gib deinen Aktivierungscode ein (auf deinem Pokemon Desktop angezeigt), um hier deine Statistiken und Pokedex zu sehen.",
      card_sync_btn: "Anmelden / Geraet verknuepfen",
      ...
      play_title: "Wer ist das Pokemon?",
      ...
      play_name_label: "Dein Name (fuer die Bestenliste)",
      play_name_placeholder: "Trainer",
      play_submit_btn: "Punktzahl senden",
      play_share_btn: "Punktzahl teilen",
      play_again_btn: "Nochmal spielen",
      play_state_correct: "Richtig! Naechstes Pokemon...",
      play_state_wrong: "Falsch! Spiel vorbei.",
      play_oak_message: "Professor Eich ist enttaeuscht von deinem Pokedex-Wissen.",
      ...
      link_title: "Pokemon Desktop verknuepfen",
      link_help: "Finde deinen Aktivierungscode auf dem Pokemon Desktop: Bildschirm auf der Startseite 4 Sekunden gedrueckt halten.",
      link_input_label: "Aktivierungscode",
      link_btn: "Geraet verknuepfen",
      link_status_none: "Noch kein Geraet verknuepft.",
      link_status_invalid: "Das sieht nicht wie ein gueltiger Aktivierungscode aus (Format XXX-XXXX-XXX).",
      link_status_linking: "Wird verknuepft...",
      link_status_linked: "Geraet verknuepft!",
      link_status_no_stats: "Verknuepft, aber noch keine Statistiken erhalten. Beende zuerst ein Spiel auf deinem Geraet.",
      link_status_error: "Geraet konnte nicht verknuepft werden. Versuche es erneut.",
      stats_title: "Deine Statistiken",
      stat_score: "Punktzahl (gesamt)",
      stat_caught: "Pokedex gefangen",
      stat_correct: "Richtige Antworten",
      stat_wrong: "Falsche Antworten",
      stat_days: "Gespielte Tage",
      stat_trainer: "Trainername",
      pokedex_title: "Deine Pokedex",
    },
  };
