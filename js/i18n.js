...
(function () {
  ...
  const dict = {
    en: {
      ...
      play_legend_title: "Become a Pokémon Desktop Legend",
      play_legend_subtitle: "Submit your score in our Leaderboard",
      ...
      linked_device_label: "Linked Device:",
      unlink_btn: "Unlink Device",
      unlink_confirm: "Unlink this device? You can link it again anytime with your Activation Code.",
    ...
    pt: {
      ...
      play_legend_title: "Torne-se uma Lenda do Pokémon Desktop",
      play_legend_subtitle: "Envie sua pontuação para o nosso Ranking",

      leaderboard_title: "Melhores sequências",
      leaderboard_col_trainer: "Treinador",
      leaderboard_col_streak: "Sequência",
      leaderboard_col_date: "Data",
      ...
      linked_device_label: "Dispositivo vinculado:",
      unlink_btn: "Desvincular dispositivo",
      unlink_confirm: "Desvincular este dispositivo? Você pode vinculá-lo novamente quando quiser com seu Código de Ativação.",
    ...
    es: {
      ...
      play_legend_title: "Convíertete en una Leyenda de Pokémon Desktop",
      play_legend_subtitle: "Envía tu puntuación a nuestra Clasificación",

      leaderboard_title: "Mejores rachas",
      leaderboard_col_trainer: "Entrenador",
      leaderboard_col_streak: "Racha",
      leaderboard_col_date: "Fecha",
      ...
      linked_device_label: "Dispositivo vinculado:",
      unlink_btn: "Desvincular dispositivo",
      unlink_confirm: "¿Desvincular este dispositivo? Puedes volver a vincularlo cuando quieras con tu Código de Activación.",
    ...
    de: {
      ...
      play_legend_title: "Werde eine Pokémon Desktop Legende",
      play_legend_subtitle: "Sende deine Punktzahl an unsere Bestenliste",

      leaderboard_title: "Beste Serien",
      leaderboard_col_trainer: "Trainer",
      leaderboard_col_streak: "Serie",
      leaderboard_col_date: "Datum",
      ...
      linked_device_label: "Verknüpftes Gerät:",
      unlink_btn: "Gerät trennen",
      unlink_confirm: "Dieses Gerät trennen? Du kannst es jederzeit mit deinem Aktivierungscode erneut verknüpfen.",
